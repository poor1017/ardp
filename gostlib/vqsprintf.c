...
#define needs_quoting(c) is_in_charset(nq_cs, (c))
...
#ifdef GL_THREADS
        pthread_mutex_lock(&(p_th_mutexPFS_VQSPRINTF_NQ_CS));
#endif /* GL_THREADS */
...
#ifdef GL_THREADS
        pthread_mutex_unlock(&(p_th_mutexPFS_VQSPRINTF_NQ_CS));
#endif /* GL_THREADS */
    }
